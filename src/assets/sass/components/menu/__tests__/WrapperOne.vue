<template>
  <div style="margin: 150px auto" class="row justify-center">
    <q-btn
      ...
      style="width: 100px"
    >
      <q-menu v-bind="$attrs" ref="menuRef" data-cy="menu">
        <q-list style="min-width: 120px">
          <q-item v-close-popup clickable data-cy="close-popup">
  ...
  <div
    data-cy="other-target"
    class="col-12 other-target bg-red q-pa-lg text-white"
  >
    Other target
  </div>
